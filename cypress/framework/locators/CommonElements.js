class CommonElements {
    ...
    static cssBlock_OrderNumber = ".order-overview__order-number";
    static cssBlock_OrderDate = ".order-overview__order-date";
    static cssBlock_OrderConfirmTo = ".order-overview__confirmation";
